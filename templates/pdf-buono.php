...
/* Footer */
.cr-footer-table { width: 100%; border-collapse: collapse; }
.cr-footer-table td { vertical-align: bottom; padding: 0; }
.cr-footer-table td.cr-footer-right { text-align: right; white-space: nowrap; }
.cr-codice-label { font-size: 7pt; color: #888; margin-right: 1mm; vertical-align: middle; }
.cr-codice {
...
<div class="card">
  ...
  <div class="card-left">
    <div class="card-left-inner">
      ...
      <div class="card-tagline">Casa Moretti 8A<br>6694 Prato-Sornico<br>info@labotegalavizzara.ch</div>
      <div class="card-extra">Valle Lavizzara · Ticino<br>labotegalavizzara.ch</div>
    </div>
  </div>

  <!-- COLONNA DESTRA -->
  <table class="card-right-table" cellpadding="0" cellspacing="0">
    <tr>
      <td class="cr-top-cell" valign="top">
        <div class="cr-top-inner">
        <div class="cr-label"><?php esc_html_e( 'CARTA REGALO', 'botega-buoni' ); ?></div>
        <div class="cr-title">Buono Regalo</div>
    ...
    <tr>
      <td class="cr-bottom-cell" valign="bottom">
        <div class="cr-bottom-inner">
        <table class="cr-footer-table" cellpadding="0" cellspacing="0">
          <tr>
            <td>
              <div class="cr-scadenza"><?php esc_html_e( 'Il buono regalo non scade mai.', 'botega-buoni' ); ?></div>
            </td>
            <td class="cr-footer-right">
              <span class="cr-codice-label"><?php esc_html_e( 'Codice:', 'botega-buoni' ); ?></span><span class="cr-codice"><?php echo esc_html( $buono->codice_buono ); ?></span>
            </td>
          </tr>
        </table>
        </div>
