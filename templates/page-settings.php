...
<div class="bb-settings-col">
    ...
    <div class="bb-card">
        ...
        <?php
        $vars_ordine = '<code>{{nome}}</code>, <code>{{ref}}</code>, <code>{{importo}}</code>, <code>{{totale}}</code>, <code>{{quantita}}</code>, <code>{{metodo}}</code>, <code>{{data}}</code>, <code>{{iban}}</code>';
        $vars_buono  = '<code>{{buoni_dettaglio}}</code> ' . esc_html__( '(blocco formattato, consigliato)', 'botega-buoni' )
            . ' &mdash; ' . esc_html__( 'oppure singolarmente:', 'botega-buoni' )
            . ' <code>{{dest_nome}}</code>, <code>{{dest_email}}</code>, <code>{{codice}}</code>, <code>{{messaggio}}</code>, <code>{{data_consegna}}</code>';
        ?>

        <div class="bb-field">
            <label><?php esc_html_e( 'Email fattura (acquirente)', 'botega-buoni' ); ?></label>
            <p class="description"><?php
                esc_html_e( 'Variabili ordine:', 'botega-buoni' );
                echo ' ' . $vars_ordine . ' &mdash; ';
                esc_html_e( 'Variabili buono:', 'botega-buoni' );
                echo ' ' . $vars_buono;
            ?></p>
