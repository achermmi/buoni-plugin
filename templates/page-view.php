        ...
        <div class="bb-view-col-main">
                ...
                <table class="widefat striped">
                    <thead>
                        <tr>
                            ...
                            <th><?php esc_html_e( 'Stato Buono', 'botega-buoni' ); ?></th>
            ...
            <div class="bb-card">
                ...
                <table class="widefat striped">
                    ...
                    <?php
                    $buono_num_map = [];
                    foreach ( $buoni as $i => $b ) {
                        $buono_num_map[ (int) $b->id ] = $i + 1;
                    }
                    foreach ( $pdfs as $pdf ) : ?>
                    <tr>
                        <td><?php echo esc_html( $pdf->tipo === 'buono' ? 'Buono #' . ( $buono_num_map[ (int) $pdf->buono_id ] ?? '?' ) : 'Fattura' ); ?></td>
